...
HRESULT Enemy::init(const char* imageName, POINT position)
{
	...
	D2DMANAGER->loadImageD2D("폭파", L"Resources/Images/ShootingGame/Effect/boom.png", 960, 576, 5, 3);
...
void Enemy::render(void)
{
	...
	{
		//D2DMANAGER->beginDraw();
		//D2DMANAGER->render("폭파", _x - D2DMANAGER->getFrameWidth() / 2, _y - D2DMANAGER->getFrameHeight() / 2,
