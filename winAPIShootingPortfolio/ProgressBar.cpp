...
HRESULT ProgressBar::init(int x, int y, int width, int height)
{
    ...
    _progressBarDown = IMAGEMANAGER->addImage("BarDown", "Resources/Images/ShootingGame/UI/redbar.bmp", 0, 0, width, height, true, RGB(255, 0, 255));
    _progressBarUp = IMAGEMANAGER->addImage("BarUp", "Resources/Images/ShootingGame/UI/greenbar.bmp", 0, 0, width, height, true, RGB(255, 0, 255));
